...
engine = create_engine('postgresql+psycopg2://sosomohhamud@localhost/fyyurDB2')
# Bind the engine to the metadata of the Base class so that the
# declaratives can be accessed through a DBSession instance

#postgresql+psycopg2://username:password@localhost/dbname
#SQLALCHEMY_DATABASE_URI = 'postgresql://sosomohhamud@localhost:5432/fyyurDB'
...
session = DBSession()
# data
# venue1 = Venue(id=1, name="The Musical Hop", city="San Francisco", state="CA", address="" , phone="", image_link ="", facebook_link="")genres
################# you have to delete id ################
 # ############# delete the ids in these entries
...
# try:
    ...
    # genres=["Jazz", "Reggae", "Swing", "Classical", "Folk"])##############  اضيفي شوز
    ...
    # seeking_description="",genres=["Classical", "R&B", "Hip-Hop"])##############  اضيفي شوز
    ...
    # seeking_description="", genres= ["Rock n Roll", "Jazz", "Classical", "Folk"])##############  اضيفي شوز
...
# # artist = Artist(name="Machina", city="city", state="", phone="" , genres="", image_link="",facebook_link="")
...
#show1 = Show(id=, start_time="", venue_id=, artists_id=, ShowType="")#  pastshow == false or post show ==true 

# show1 = Show( start_time="2019-05-21T21:30:00.000Z", venue1.id, artist4.id, ShowType=False)#  pastshow == false or post show ==true 
# show2 = Show( start_time="2019-06-15T23:00:00.000Z", venue3.id, artist5.id, ShowType=False)#  pastshow == false or post show ==true 
# show3 = Show(start_time="2035-04-01T20:00:00.000Z", venue3.id, artist6.id, ShowType=True)#  pastshow == false or post show ==true 
# show4 = Show( start_time="2035-04-08T20:00:00.000Z", venue3.id, artist6.id, ShowType=True)#  pastshow == false or post show ==true 
# show5 = Show(start_time="2035-04-15T20:00:00.000Z", venue3.id, artist6.id, ShowType=True)#  pastshow == false or post show ==true 

# show1 = Show( start_time="2019-05-21T21:30:00.000Z", ShowType=False)#  pastshow == false or post show ==true 
# show2 = Show( start_time="2019-06-15T23:00:00.000Z", ShowType=False)#  pastshow == false or post show ==true 
# show3 = Show(start_time="2035-04-01T20:00:00.000Z",ShowType=True)#  pastshow == false or post show ==true 
# show4 = Show( start_time="2035-04-08T20:00:00.000Z",  ShowType=True)#  pastshow == false or post show ==true 
# show5 = Show(start_time="2035-04-15T20:00:00.000Z", ShowType=True)#  pastshow == false or post show ==true 
